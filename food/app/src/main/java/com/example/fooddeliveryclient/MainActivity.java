...
TextView code;
    ...
    public void onStart() {
        ...
        if (mVerificationInProgress && validatePhoneNumber()) {
            startPhoneNumberVerification(code.getText().toString()+mPhoneNumberField.getText().toString());
        }
        // [END_EXCLUDE]
    }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            intent.putExtra("phno",user.getPhoneNumber());
            ...
            case STATE_VERIFY_SUCCESS:
                ...
                if (cred != null) {
                    if (cred.getSmsCode() != null) {
                        ...
                        mVerificationField.setText("already signed user");
                    }
                }
